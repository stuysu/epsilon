...
module.exports = {
  ...
  theme : {
    ...
    extend : {
      ...
      boxShadow : {
        prominent : "0 4px 20px 10px var(--shadow-base), 0 3px 4px 2px var(--shadow-base), 0 0 3px 0 var(--shadow-antithesis) inset, 0 -7px 20px 0 var(--shadow-fume) inset",
        control : "0 4px 4px 0 var(--shadow-base), 0 0 1px 0 var(--shadow-antithesis) inset, 0 1px 3px 0 var(--shadow-decoration) inset",
