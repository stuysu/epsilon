...
const Support = () => {
    return (
        <div className={"m-10 sm:m-12 max-sm:mb-32"}>
            <Helmet>
                <title>StuyActivities Support - Sigma</title>
                <meta
                    name="description"
            ...
            <div className={"max-sm:-mr-4"}>
                ...
                it will appear on the Sigma website and you'll receive an email confirmation.
                ...
                <HelpItem
                    ...
                    content="We may have shared specific details regarding why the submission was denied with you
                     via the Activity’s Messaging channel on Sigma. Please review it carefully and determine
                ...
                You can also encourage them to visit the Sigma website and search for your Activity in the catalog. In the future, you will be able to invite members with a one-time link that bypasses the need for approval."
                />
                <Divider />
                <HelpItem
                    icon="bx-mail-send"
