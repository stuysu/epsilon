    ...
    return (
        <Box sx={{ padding: "40px"}}>
			...
			<Typography paragraph>
				If you are experiencing technical issues or difficulties regarding the Epsilon website, please
				contact us at it@stuysu.org, clubpu@stuysu.org, or an SU
				representative.
			</Typography>
			<Typography>
				<ol>
					<li>
						...
						<Link color="secondary" to="https://epsilon.stuysu.org/catalog">
							Epsilon website
						</Link>
					...
					<li>
						...
						meeting on the Epsilon website. Any Activity found inactive for more than one month may
			...
			<Typography paragraph>
				<ol>
					...
					<li>Links to all official online Activity meetings must be accessible on Epsilon.</li>
					<li>
						All official Activity meetings must be scheduled on Epsilon.
						<ul>
					...
					<li>
						...
						ended. Report the issue to MPolazz@schools.nyc.gov and clubpub@stuysu.org
					</li>
					<li>
						Please email it@stuysu.org for general technical support and support using
						Epsilon.
					</li>
				</ol>
			</Typography>
					...
					<li>
						...
						<ul>
							<li>
								...
								clubpub@stuysu.org, the COSA (Mr. Polazzo) and the Assistant
								...
								MPolazz@schools.nyc.gov and can be found in Room 260. Mr. Moran
								can be reached at BMoran@schools.nyc.gov and can be found in Room
								103.
							</li>
							<li>
			...
			<Typography>
				<ol>
					<li>All Activities must reserve a room on Epsilon to be able to hold a meeting.</li>
					<li>
					...
					<li>
						...
						clubpub@stuysu.org with the Subject: “Long Term Room Reservation:
					...
					<li>
						All Activities must use the room reserved for their activity on the Epsilon website.
						Please email clubpub@stuysu.org or contact an SU representative if you are
					...
					<li>
						...
						<ul>
							<li>
								...
								clubpub@stuysu.org, the Student Union COSA, Mr. Polazzo, and the
			...
			<Typography>
				<ol>
					...
					<li>
						...
						be sent to clubpub@stuysu.org and budget@stuysu.org{" "}
					...
					<li>
						...
						<ul>
							<li>
								...
								the SU Budget Department (budget@stuysu.org
					...
					<li>
						...
						<ul>
							...
							<li>
								...
								date) to the Budget Department (budget@stuysu.org) within seven
								days of purchase.
							</li>
